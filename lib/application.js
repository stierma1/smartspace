...
Application.prototype.reclassifyProvider = function(providerId, addClasses, removeClasses){
  for(var i in removeClasses){
    this.graph.removeClass(providerId, removeClasses[i]);
  }
  for(var i in addClasses){
    this.graph.addClass(providerId, addClasses[i]);
  }
}
